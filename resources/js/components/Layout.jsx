...
const navigation = [
  ...
  { name: 'Voter CRM', href: '/voter-crm', icon: UsersIcon },
  { name: 'Communication', href: '/communication', icon: ChatBubbleLeftRightIcon },
  { name: 'Ticketing', href: '/ticketing', icon: TicketIcon },
  { name: 'Calendar', href: '/calendar', icon: CalendarIcon },
  { name: 'News & Events', href: '/news-events', icon: NewspaperIcon },
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <h1 className="text-xl font-bold text-gray-900">NetaSampark</h1>
            <button
        ...
        <div className="flex h-16 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              <span className="text-sm text-gray-700">Welcome to NetaSampark</span>
            </div>
          </div>
        </div>
